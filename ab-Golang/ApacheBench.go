...
import (
	...
	"github.com/raireyouja/Entrust/ab-Golang/stats"
...
func PrintUsage() {
	fmt.Println("go-ab: wrong number of arguments")
	fmt.Println("Usage: go run go-ab.go [options] [http[s]://]hostname[:port]/path")
